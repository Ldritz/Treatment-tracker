class ProductionLog {
  ...
  factory ProductionLog.fromJson(Map<String, dynamic> json) {
    return ProductionLog(
      ...
      eggMass: (json['egg_mass'] ?? json['eggMass'] as num?)?.toDouble() ?? 0.0,
      quails: (json['quails'] as num).toDouble(),
      days: (json['days'] as num).toDouble(),
      feedGiven: (json['feed_given'] ?? json['feedGiven'] as num?)?.toDouble() ?? 0.0,
      feedRefusal: (json['feed_refusal'] ?? json['feedRefusal'] as num?)?.toDouble() ?? 0.0,
