class ProductionLog {
  ...
  factory ProductionLog.fromJson(Map<String, dynamic> json) {
    return ProductionLog(
      ...
      eggMass: (json['eggMass'] ?? json['egg_mass'] as num?)?.toDouble() ?? 0.0,
      quails: (json['quails'] as num).toDouble(),
      days: (json['days'] as num).toDouble(),
      feedGiven: (json['feedGiven'] ?? json['feed_given'] as num?)?.toDouble() ?? 0.0,
      feedRefusal: (json['feedRefusal'] ?? json['feed_refusal'] as num?)?.toDouble() ?? 0.0,
