    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: AppTheme.surfaceHighest, // Tones down the nesting
            borderRadius: BorderRadius.circular(12),
          ),
          child: Column(
            children: layout.map((row) {
              return Padding(
                padding: EdgeInsets.only(bottom: layout.indexOf(row) == layout.length - 1 ? 0 : 8.0),
                child: Row(
                              ...
                              if (indicatorContext != null) ...[
                                ...
                                Icon(
                                  ...
                                  color: isFilled 
                                      ...
                                      : (isSelected ? Colors.white70 : AppTheme.textMuted.withValues(alpha: 0.5)),
                                ),
                              ],
                            ],
                          ),
