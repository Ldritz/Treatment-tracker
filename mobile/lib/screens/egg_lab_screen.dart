      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                StatBox(label: 'HU', value: haughUnit.toStringAsFixed(1), color: const Color(0xFF818CF8)),
                const SizedBox(width: 8),
                StatBox(label: 'Shape', value: shapeIndex.toStringAsFixed(1), suffix: '%', color: theme.colorScheme.secondary),
                const SizedBox(width: 8),
