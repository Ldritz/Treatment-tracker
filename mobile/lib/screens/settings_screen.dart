...
class SettingsScreen extends StatelessWidget {
  ...
  void _updateName(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text('Edit Researcher Name', style: TextStyle(color: theme.textTheme.displaySmall?.color)),
        content: TextField(
  ...
  void _disconnectCloud(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        backgroundColor: theme.colorScheme.surface,
        title: Text('Disconnect Cloud Sync?', style: TextStyle(color: theme.textTheme.displaySmall?.color)),
        content: Text(
          'Your data will stay safe on this device, but it will no longer be backed up to the cloud. You can reconnect anytime.',
          style: TextStyle(color: theme.textTheme.bodyLarge?.color),
        ),
        actions: [
          TextButton(
          ...
          TextButton(
            ...
            child: Text('Disconnect', style: TextStyle(color: theme.colorScheme.error, fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
  ...
  void _clearLogs(BuildContext context, bool isDaily) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        backgroundColor: theme.colorScheme.surface,
        title: Text(
          isDaily ? 'Clear Daily Logs?' : 'Clear Egg Lab Logs?', 
          style: TextStyle(color: theme.textTheme.displaySmall?.color)
        ),
        content: Text(
          'This action cannot be undone. All local logs for this category will be permanently deleted.',
          style: TextStyle(color: theme.textTheme.bodyLarge?.color),
        ),
        actions: [
          TextButton(
          ...
          TextButton(
            ...
            child: Text('Clear All', style: TextStyle(color: theme.colorScheme.error, fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
